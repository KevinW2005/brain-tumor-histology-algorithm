...
Building a detection model using a convolutional neural network in Tensorflow<br>
Used brain histological slides

**About the data:**<br>
The dataset contains 2 folders: yes and no which contains 19 histological slide Images. The folder yes contains 4 histological slides and the folder no contains 15 histological slides that are non-tumorous.
...
4 positive and 15 negative examples, resulting in 19 example images.

After data augmentation, now the dataset consists of:<br>
8 positive and 30 negatives examples.
